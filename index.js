// var app_ids = [{
//   "hfretdytcuychdyd":"chrome_browser"
// }];


document.addEventListener('contextmenu', function(e) {
  $(".contextmenu").toggleClass("hidden")
  e.preventDefault();
}, false);



function launch_app(id, html, x, y, w, h) {
  if (document.querySelector("." + id) == null ) {
    var wc = document.createElement("div");
    $(wc).addClass("window")
    $(wc).addClass(id);
    $(".desktop").append(wc);
    $(wc).attr("w3-inlcude-html", html)
    $(wc).css({"top": "25px", "left": "450px", "width": "800px", "height": "450px"});
    makeResizable(document.querySelector("." + id),100,100, 20)
  }else {
    if(document.querySelector("." + id).style.opacity == 1) {
...
$("#browser_chrome").click(function(){
  launch_app("browser_chrome", "apps/browser_chrome.html");
});



function makeResizable(element, minW = 100, minH = 100, size = 40)
{
